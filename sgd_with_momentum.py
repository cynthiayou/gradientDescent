...
def sgd_with_momentum_for_linear_reg(X, y, theta, alpha, velocity, decay_factor, epochs):
    m = y.size
    cost_history = []
    best_theta = 0
...
def sgd_with_momentum_for_logistic_reg(X, y, theta, alpha, velocity, decay_factor, epochs):
    m = y.size
    cost_history = []
    best_theta = 0
    cost_threshold = float('inf')
